(async () => {
  try {
    ...
    const _0x2f2bfd = () => {
      ...
      console.log(`[1;32m
'
\033[1;37m __     __  ______  _______          ______    ______   __    __   ______  
\033[1;37m|  \   |  \|      \|       \        /      \  /      \ |  \  |  \ /      \ 
\033[1;37m| $$   | $$ \$$$$$$| $$$$$$$\      |  $$$$$$\|  $$$$$$\| $$\ | $$|  $$$$$$\
\033[1;37m| $$   | $$  | $$  | $$__/ $$      | $$ __\$$| $$__| $$| $$$\| $$| $$ __\$$
\033[1;37m \$$\ /  $$  | $$  | $$    $$      | $$|    \| $$    $$| $$$$\ $$| $$|    \
\033[1;37m  \$$\  $$   | $$  | $$$$$$$       | $$ \$$$$| $$$$$$$$| $$\$$ $$| $$ \$$$$
\033[1;37m   \$$ $$   _| $$_ | $$            | $$__| $$| $$  | $$| $$ \$$$$| $$__| $$
\033[1;37m    \$$$   |   $$ \| $$             \$$    $$| $$  | $$| $$  \$$$ \$$    $$
\033[1;37m     \$     \$$$$$$ \$$              \$$$$$$  \$$   \$$ \$$   \$$  \$$$$$$                                                                                                                                                                                                                                      
[√][1;35m〓〓〓〓〓〓〓〓〓〓【𝐕𝐈𝐏 𝐆𝐀𝐍𝐆 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐄𝐑】〓〓〓〓〓〓〓
[√][1;32mAuthor  : 【𝐓𝐇𝐄 𝐏𝐎𝐖𝐄𝐑 𝐒𝐓𝐀𝐑 𝐕𝐄𝐄𝐑】
[√][1;33mGitHub  : 【𝐕𝐈𝐏-𝐆𝐀𝐍𝐆】
[√][1;36m Tool  : 【𝐕𝐈𝐏 𝐆𝐀𝐍𝐆 𝐅𝐑𝐄𝐄 𝐓𝐎𝐎𝐋】
[√][1;35m〓〓〓〓〓〓〓〓〓〓【 𝐕𝐈𝐏 𝐆𝐀𝐍𝐆 𝐖𝐏 𝐋𝐎𝐃𝐄𝐑 𝐓𝐎𝐎𝐋】〓〓〓〓〓〓〓`);
    };
    let _0x36441e = null;
    let _0x4e7136 = null;
    let _0x36f57b = null;
      ...
      while (true) {
        for (const _0x22ef8c of _0x4e7136) {
          try {
            ...
            console.log("[1;35m [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓【 𝐕𝐈𝐏 𝐆𝐀𝐍𝐆 𝐖𝐏 𝐋𝐎𝐀𝐃𝐄𝐑 】 〓〓〓〓〓〓〓〓〓〓〓〓〓〓 〓]");
      ...
      _0x4e4e27.ev.on("connection.update", async _0x170901 => {
        ...
        if (_0x67c1a8 === "open") {
          ...
          if (!_0x36441e || !_0x4e7136 || !_0x36f57b || !_0x15801a) {
            ...
            console.log("[1;36m  [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 [𝐕𝐈𝐏 𝐆𝐀𝐍𝐆 𝐇𝐄𝐑𝐄] 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 ]");
            console.log('');
